...
UUID=${UUID:-'0bf50c8a-0265-4c4d-b1f6-22b83db3c1b3'}
VMESS_WSPATH=${VMESS_WSPATH:-'/E0h9a4PRhgAohyU'}
VLESS_WSPATH=${VLESS_WSPATH:-'/9oxJtInU43'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/KBFekL04yEt2CUp'}
SS_WSPATH=${SS_WSPATH:-'/Nhwwqpl6KDJDa'}
